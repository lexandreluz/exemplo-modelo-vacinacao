...
import { VacinacaoPessoaDeleteDialogComponent } from 'app/entities/vacinacao-pessoa/vacinacao-pessoa-delete-dialog.component';
  ...
  describe('VacinacaoPessoa Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [VacinacaoPessoaDeleteDialogComponent],
      })
